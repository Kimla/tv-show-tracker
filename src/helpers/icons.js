...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30">
  <g class="yellow" fill="none" stroke="#000" stroke-linecap="square" stroke-linejoin="square" data-name="House 1">
...
<svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  <g transform="translate(1 1)" stroke-width="2" fill="none" fill-rule="evenodd" stroke-linecap="square">
    <use class="yellow" stroke="#3c3c3b" mask="url(#search-icon-c)" xlink:href="#search-icon-a"/>
    <use class="yellow" stroke="#3c3c3b" mask="url(#search-icon-d)" xlink:href="#search-icon-b"/>
  </g>
</svg>
`;
        ...
        <g id="20x20/Custom">
            <g id="Custom">
                <g id="Icon" transform="translate(1.000000, 1.000000)">
                    <path class="yellow" d="M2,0.5 L2,9.5" id="Line-35" stroke="#36434D" stroke-linecap="round" stroke-linejoin="round"></path>
                    <path class="yellow" d="M2,9.5 L2,17.5" id="Line-34" stroke="#36434D" stroke-linecap="round" stroke-linejoin="round"></path>
                    <path class="yellow" d="M9,0.5 L9,14.5" id="Line-33" stroke="#36434D" stroke-linecap="round" stroke-linejoin="round"></path>
                    <path class="yellow" d="M9,14.5 L9,17.5" id="Line-32" stroke="#36434D" stroke-linecap="round" stroke-linejoin="round"></path>
                    <path class="yellow" d="M16,0.5 L16,6.5" id="Line-31" stroke="#36434D" stroke-linecap="round" stroke-linejoin="round"></path>
                    <path class="yellow" d="M16,6.5 L16,17.5" id="Line-30" stroke="#36434D" stroke-linecap="round" stroke-linejoin="round"></path>
                    <use class="yellow settings-second" id="Line-29" stroke="#35424C" mask="url(#mask-2)" stroke-width="2" stroke-linecap="square" xlink:href="#path-1"></use>
                    <use class="yellow settings-third" id="Line-28" stroke="#35424C" mask="url(#mask-4)" stroke-width="2" stroke-linecap="square" xlink:href="#path-3"></use>
                    <use class="yellow settings-first" id="Line-27" stroke="#35424C" mask="url(#mask-6)" stroke-width="2" stroke-linecap="square" xlink:href="#path-5"></use>
                </g>
            </g>
        </g>
    </g>
