...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30">
  <g class="yellow" fill="none" stroke="#999" stroke-linecap="square" stroke-linejoin="square" data-name="House 1">
...
<svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  <g transform="translate(1 1)" stroke-width="2" fill="none" fill-rule="evenodd" stroke-linecap="square">
    <use class="yellow" stroke="#999" mask="url(#search-icon-c)" xlink:href="#search-icon-a"/>
    <use class="yellow" stroke="#999" mask="url(#search-icon-d)" xlink:href="#search-icon-b"/>
  </g>
</svg>
`;
        ...
        <g id="20x20/Custom">
            <g id="Custom">
                <g id="Icon" transform="translate(1.000000, 1.000000)">
                    <path class="yellow" d="M2,0.5 L2,9.5" id="Line-35" stroke="#999" stroke-linecap="round" stroke-linejoin="round"></path>
                    <path class="yellow" d="M2,9.5 L2,17.5" id="Line-34" stroke="#999" stroke-linecap="round" stroke-linejoin="round"></path>
                    <path class="yellow" d="M9,0.5 L9,14.5" id="Line-33" stroke="#999" stroke-linecap="round" stroke-linejoin="round"></path>
                    <path class="yellow" d="M9,14.5 L9,17.5" id="Line-32" stroke="#999" stroke-linecap="round" stroke-linejoin="round"></path>
                    <path class="yellow" d="M16,0.5 L16,6.5" id="Line-31" stroke="#999" stroke-linecap="round" stroke-linejoin="round"></path>
                    <path class="yellow" d="M16,6.5 L16,17.5" id="Line-30" stroke="#999" stroke-linecap="round" stroke-linejoin="round"></path>
                    <use class="yellow settings-second" id="Line-29" stroke="#999" mask="url(#mask-2)" stroke-width="2" stroke-linecap="square" xlink:href="#path-1"></use>
                    <use class="yellow settings-third" id="Line-28" stroke="#999" mask="url(#mask-4)" stroke-width="2" stroke-linecap="square" xlink:href="#path-3"></use>
                    <use class="yellow settings-first" id="Line-27" stroke="#999" mask="url(#mask-6)" stroke-width="2" stroke-linecap="square" xlink:href="#path-5"></use>
                </g>
            </g>
        </g>
    </g>
...
<svg height="512" viewBox="0 0 512 512" width="512" xmlns="http://www.w3.org/2000/svg">
  <g id="expanded">
    <path class="yellow-fill" fill="#999" d="M455 463H254a8 8 0 0 1 0-16h193V65H254a8 8 0 0 1 0-16h201a8 8 0 0 1 8 8v398a8 8 0 0 1-8 8z"/>
    <path class="yellow-fill arrow" fill="#999"d="M367.747 254.003a7.999 7.999 0 0 0-2.09-3.661l-82-81.999a8 8 0 0 0-11.314 11.313L340.688 248H104a7.99 7.99 0 0 0-1.357.124C99.404 239.02 90.715 232.5 80.5 232.5 67.521 232.5 57 243.021 57 256s10.521 23.5 23.5 23.5c10.215 0 18.904-6.52 22.143-15.624A7.99 7.99 0 0 0 104 264h236.686l-68.343 68.343a8 8 0 0 0 11.314 11.314l82-82a8 8 0 0 0 2.09-7.654zM80.5 263.5c-4.136 0-7.5-3.364-7.5-7.5s3.364-7.5 7.5-7.5 7.5 3.364 7.5 7.5-3.364 7.5-7.5 7.5z"/>
  </g>
</svg>
`;
...
<svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
  <path class="yellow-fill" fill="#999" d="M24 26c6.6 0 12-5.4 12-12S30.6 2 24 2 12 7.4 12 14s5.4 12 12 12zm0-22c5.5 0 10 4.5 10 10s-4.5 10-10 10-10-4.5-10-10S18.5 4 24 4zM33 28H15C7.8 28 2 33.8 2 41v5h2v-5c0-6.1 4.9-11 11-11h18v-2zM46 38h-6v-6h-2v6h-6v2h6v6h2v-6h6z"/>
</svg>
`;
